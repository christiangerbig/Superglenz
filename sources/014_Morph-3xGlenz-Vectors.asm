; ###########################################
; # Programm: 014_Morph-Glenz-3xVectors.asm #
...
; Linien-Blits nur 1x initialisiert werden müssen.
  ...
  XDEF start_014_morph_3xglenz_vectors
...
mgv_morph_shape5_delay              EQU 8*PALFPS
...
vsp_min_VSTART                      EQU VSTART_144_lines
...
; ------------------------------------------
start_014_morph_3xglenz_vectors
  INCLUDE "sys-init.i"
...
; **** Morph-Glenz-Vectors ****
  ...
  moveq   #FALSE,d1
  move.w  d1,mgv_pre_rotate_state(a3)
...
mgv_pre_rotate_objects
  tst.w   mgv_pre_rotate_state(a3) ;Pre-Rotation an ?
...
; ** Object 3 **
  ...
  moveq   #TRUE,d0
  move.w  d0,mgv_pre_rotate_state(a3) ;Pre-Rotation an
...
mgv_glenz_color_table
  INCLUDE "Daten:Asm-Sources.AGA/Superglenz/colortables/3xGlenz-Colorgradient.ct"
