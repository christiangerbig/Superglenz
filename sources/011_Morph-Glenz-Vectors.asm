...
mgv_x_anglespeed_center		EQU 3
mgv_x_anglespeed_speed		EQU 2

mgv_y_anglespeed_radius		EQU 2
mgv_y_anglespeed_center		EQU 4
mgv_y_anglespeed_speed		EQU 2

mgv_z_anglespeed_radius		EQU 1
mgv_z_anglespeed_center		EQU 2
...
; Central projection and translation
	...
	MULSF.W mgv_distance,d1,d3	; y projekction
...
mgv_rgb8_color_table
	INCLUDE "Superglenz:colorpalettes/1xGlenz-Colorgradient2.ct"
