...
; Morph-Glenz-Vectors
	moveq	#TRUE,d0
	move.w	d0,mgv_object1_x_angle(a3) ; 0°
	move.w	d0,mgv_object1_y_angle(a3) ; 0°
	move.w	d0,mgv_object1_z_angle(a3) ; 0°

	move.w	d0,mgv_object2_x_angle(a3) ; 0°
	move.w	d0,mgv_object2_y_angle(a3) ; 0°
	move.w	d0,mgv_object2_z_angle(a3) ; 0°
...
mgv_get_colorvalues_average
	...
	moveq	#0,d4
	move.b	WORD_SIZE(a0,d7.w*4),d4	; 2nd source color grün
	moveq	#0,d5
...
mgv_draw_lines_loop1
	...
	move.w	WORD_SIZE(a5),d5	; p2 starts
	move.w	LONGWORD_SIZE(a5),d6	; p3 starts
