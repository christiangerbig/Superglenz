...
; Morphendes 1x40-Flächen-Glenz auf einem 256x256-Screen.
...
mgv_glenz_color_table
  INCLUDE "Daten:Asm-Sources.AGA/Superglenz/colortables/1xGlenz-Colorgradient3.ct"
