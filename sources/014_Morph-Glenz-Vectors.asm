...
mgv_x_angle_speed_radius	EQU 4
mgv_x_angle_speed_center	EQU 6
mgv_x_angle_speed_speed		EQU 4

mgv_y_angle_speed_radius	EQU 4
mgv_y_angle_speed_center	EQU 4
mgv_y_angle_speed_speed		EQU 2

mgv_z_angle_speed_radius	EQU 1
mgv_z_angle_speed_center	EQU 2
mgv_z_angle_speed_speed		EQU 2
...
mgv_x_speed			RS.W 1
mgv_x_angle_speed_angle		RS.W 1
mgv_y_speed			RS.W 1
mgv_y_angle_speed_angle		RS.W 1
mgv_z_speed			RS.W 1
mgv_z_angle_speed_angle		RS.W 1
...
; Morphing-Glenz-Vectors
	...
	move.w	d0,mgv_x_angle_speed_angle(a3)
	move.w	d0,mgv_y_speed(a3)
	move.w	d0,mgv_y_angle_speed_angle(a3)
	move.w	d0,mgv_z_speed(a3)
	move.w	d0,mgv_z_angle_speed_angle(a3)
...
mgv_calc_xyz_speed
	...
	add.w	#mgv_x_angle_speed_center,d0
	move.w	d0,mgv_x_speed(a3)
	add.w	#mgv_x_angle_speed_speed,d2
	and.w	d3,d2			; remove overflow
	move.w	d2,mgv_x_angle_speed_angle(a3)

	move.w	mgv_y_angle_speed_angle(a3),d2
	move.w	(a0,d2.w*2),d0		; sin(w)
	MULSF.W mgv_y_angle_speed_radius*2,d0,d1 ; y speed = (r*sin(w))/2^15
	swap	d0
	add.w	#mgv_y_angle_speed_center,d0
	move.w	d0,mgv_y_speed(a3)
	add.w	#mgv_y_angle_speed_speed,d2
	and.w	d3,d2			; remove overflow
	move.w	d2,mgv_y_angle_speed_angle(a3)

	move.w	mgv_z_angle_speed_angle(a3),d2
	move.w	(a0,d2.w*2),d0		; sin(w)
	MULSF.W mgv_z_angle_speed_radius*2,d0,d1 ; z speed = (r*sin(w))/2^15
	swap	d0
	add.w	#mgv_z_angle_speed_center,d0
	move.w	d0,mgv_z_speed(a3)
	add.w	#mgv_z_angle_speed_speed,d2
	and.w	d3,d2			; remove overflow
	move.w	d2,mgv_z_angle_speed_angle(a3)
	rts
