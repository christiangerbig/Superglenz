...
gv_clear_playfield1
  ...
  move.l  d0,a5
  move.l  d0,a6
  moveq   #7-1,d7            ;Anzahl der Durchläufe
gv_clear_playfield1_loop
  REPT ((pf1_plane_width*pf1_y_size3*pf1_depth3)/56)/7
...
; ** Diamant für 192x192-Screen **
    DC.W 0,-(53*8),0             ;P0
    DC.W -(21*8),-(53*8),-(50*8) ;P1
    DC.W 21*8,-(53*8),-(50*8)    ;P2
    DC.W 50*8,-(53*8),-(21*8)    ;P3
    DC.W 50*8,-(53*8),21*8       ;P4
    DC.W 21*8,-(53*8),50*8       ;P5
    DC.W -(21*8),-(53*8),50*8    ;P6
    DC.W -(50*8),-(53*8),21*8    ;P7
    DC.W -(50*8),-(53*8),-21*8   ;P8
    DC.W 0*8,-(30*8),-(68*8)     ;P9
    DC.W 47*8,-(30*8),-(47*8)    ;P10
    DC.W 68*8,-(30*8),0*8        ;P11
    DC.W 47*8,-(30*8),47*8       ;P12
    DC.W 0*8,-(30*8),68*8        ;P13
    DC.W -(47*8),-(30*8),47*8    ;P14
    DC.W -(68*8),-(30*8),0*8     ;P15
    DC.W -(47*8),-(30*8),-(47*8) ;P16
    DC.W -(27*8),-(30*8),-(68*8) ;P17
    DC.W 27*8,-(30*8),-(68*8)    ;P18
    DC.W 68*8,-(30*8),-(27*8)    ;P19
    DC.W 68*8,-(30*8),27*8       ;P20
    DC.W 27*8,-(30*8),68*8       ;P21
    DC.W -(27*8),-(30*8),68*8    ;P22
    DC.W -(68*8),-(30*8),27*8    ;P23
    DC.W -(68*8),-(30*8),-(27*8) ;P24
    DC.W 0*8,28*8,0*8            ;P25
...
gv_object_edge_table
  DC.W 0*2,6*2,5*2,0*2       ;Flächen oben
  ...
  DC.W 2*2,9*2,1*2,2*2       ;Flächen mitte
  ...
  DC.W 25*2,21*2,22*2,25*2   ;Flächen unten
